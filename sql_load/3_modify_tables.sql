...
COPY company_dim
FROM 'C:\SQL_Data_Analysis_Jobs_Project_csvFiles\company_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_dim
FROM 'C:\SQL_Data_Analysis_Jobs_Project_csvFiles\skills_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY job_postings_fact
FROM 'C:\SQL_Data_Analysis_Jobs_Project_csvFiles\job_postings_fact.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_job_dim
FROM 'C:\SQL_Data_Analysis_Jobs_Project_csvFiles\skills_job_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
